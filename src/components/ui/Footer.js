...
export default function Footer() {
  ...
  return (
    <footer ref={footerRef} className="relative w-full h-screen flex flex-col" style={{ backgroundColor: '#0a0a0a' }}>
